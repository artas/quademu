...
/*Table structure for table `bonus_system` */
...
CREATE TABLE `creature` (
  ...
  KEY `idx_map` (`map`),
  KEY `index_id` (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=4467708 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='Creature System';
SET character_set_client = @saved_cs_client;
...
CREATE TABLE `creature_ai_scripts` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=670001553 DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='EventAI Scripts';
SET character_set_client = @saved_cs_client;
...
CREATE TABLE `creature_onkill_reputation` (
  `creature_id` mediumint(8) unsigned NOT NULL default '0',
...
CREATE TABLE `creature_template_addon` (
  ...
  `auras` text,
  PRIMARY KEY  (`entry`)
) ENGINE=MyISAM AUTO_INCREMENT=34320 DEFAULT CHARSET=utf8;
SET character_set_client = @saved_cs_client;
...
CREATE TABLE `game_tele` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1428 DEFAULT CHARSET=utf8 COMMENT='Tele Command';
SET character_set_client = @saved_cs_client;
...
CREATE TABLE `gameobject` (
  ...
  PRIMARY KEY  (`guid`)
) ENGINE=MyISAM AUTO_INCREMENT=798749 DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='Gameobject System';
SET character_set_client = @saved_cs_client;
...
CREATE TABLE `quest_template` (
  ...
  `ReqNpcOrGOId1` mediumint(9) NOT NULL default '0',
  `ReqNpcOrGOId2` mediumint(9) NOT NULL default '0',
  `ReqNpcOrGOId3` mediumint(9) NOT NULL default '0',
  `ReqNpcOrGOId4` mediumint(9) NOT NULL default '0',
  ...
  `RewRepFaction3` smallint(5) unsigned NOT NULL default '0',
  `RewRepFaction4` smallint(5) unsigned NOT NULL default '0',
  `RewRepFaction5` smallint(5) unsigned NOT NULL default '0',
...
CREATE TABLE `skill_discovery_template` (
  ...
  `reqSpell` mediumint(8) unsigned NOT NULL default '0',
...
/*Table structure for table `quad_string` */

DROP TABLE IF EXISTS `quad_string`;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
CREATE TABLE `quad_string` (
  `entry` mediumint(8) unsigned NOT NULL default '0',
  `content_default` text NOT NULL,
  `content_loc1` text,
  `content_loc2` text,
