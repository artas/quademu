        ...
        case GO_READY:
        {
            ...
            if(isSpawned())
            {
                ...
                if(goInfo->type == GAMEOBJECT_TYPE_TRAP)
                {
                    ...
                    {
                        Quad::AnyUnfriendlyNoTotemUnitInObjectRangeCheck checker(this, owner, radius);
                        Quad::UnitSearcher<Quad::AnyUnfriendlyNoTotemUnitInObjectRangeCheck> searcher(this, ok, checker);
...
void GameObject::TriggeringLinkedGameObject( uint32 trapEntry, Unit* target)
{
    ...
    GameObject* trapGO = NULL;
    {
        ...
        TypeContainerVisitor<Quad::GameObjectLastSearcher<Quad::NearestGameObjectEntryInObjectRangeCheck>, GridTypeMapContainer > object_checker(checker);
...
GameObject* GameObject::LookupFishingHoleAround(float range)
{
    ...
    TypeContainerVisitor<Quad::GameObjectSearcher<Quad::NearestGameObjectFishingHole>, GridTypeMapContainer > grid_object_checker(checker);
