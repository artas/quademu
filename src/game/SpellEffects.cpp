...
{
    // NOT USED BY ANY SPELL OR USELESS OR IMPLEMENTED IN DIFFERENT WAY IN CORE
}
...
void Spell::EffectSanctuary(uint32 /*i*/)
{
    ...
    Quad::AnyUnfriendlyUnitInObjectRangeCheck u_check(unitTarget, unitTarget, m_caster->GetMap()->GetVisibilityDistance());
    Quad::UnitListSearcher<Quad::AnyUnfriendlyUnitInObjectRangeCheck> searcher(unitTarget, targets, u_check);
