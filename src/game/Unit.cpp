...
Unit* Unit::SelectNearbyTarget(float dist) const
{
    ...
    Quad::AnyUnfriendlyUnitInObjectRangeCheck u_check(this, this, dist);
    Quad::UnitListSearcher<Quad::AnyUnfriendlyUnitInObjectRangeCheck> searcher(this, targets, u_check);
