...
#ifndef QUAD_WAYPOINTMOVEMENTGENERATOR_H
#define QUAD_WAYPOINTMOVEMENTGENERATOR_H
...
class QUAD_DLL_SPEC PathMovementBase
{
    public:
...
class QUAD_DLL_SPEC WaypointMovementGenerator
 ...
 */
class QUAD_DLL_SPEC FlightPathMovementGenerator
