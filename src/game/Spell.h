...
class Spell
{
    friend struct Quad::SpellNotifierCreatureAndPlayer;
    ...
    public:
        ...
        static void CORE_DLL_SPEC SendCastResult(Player* caster, SpellEntry const* spellInfo, uint8 cast_count, SpellCastResult result);
...
namespace Quad
{
    struct QUAD_DLL_DECL SpellNotifierCreatureAndPlayer
    {
