...
void WorldSession::HandleMovementOpcodes( WorldPacket & recv_data )
{
    ...
    if (!Quad::IsValidMapCoord(movementInfo.x, movementInfo.y, movementInfo.z, movementInfo.o))
    {
        recv_data.rpos(recv_data.wpos());                   // prevent warnings spam
        return;
    }
	...
	}else if (movementInfo.flags & MOVEMENTFLAG_ONTRANSPORT)
    {
        ...
        if (!Quad::IsValidMapCoord(movementInfo.x+movementInfo.t_x, movementInfo.y + movementInfo.t_y,
