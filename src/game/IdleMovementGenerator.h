...
#ifndef QUAD_IDLEMOVEMENTGENERATOR_H
#define QUAD_IDLEMOVEMENTGENERATOR_H

#include "MovementGenerator.h"

class QUAD_DLL_SPEC IdleMovementGenerator : public MovementGenerator
{
    public:
...
class QUAD_DLL_SPEC RotateMovementGenerator : public MovementGenerator
{
    public:
...
class QUAD_DLL_SPEC DistractMovementGenerator : public MovementGenerator
{
    public:
