...
//        { "auctions",                    SEC_ADMINISTRATOR, true,  &ChatHandler::HandleReloadAuctionsCommand,                "", NULL },
        ...
        { "quad_string",              SEC_ADMINISTRATOR, true,  &ChatHandler::HandleReloadQuadStringCommand,           "", NULL },
        { "auctions",                    SEC_ADMINISTRATOR, true,  &ChatHandler::HandleReloadAuctionsCommand,                "", NULL },
    ...
    static ChatCommand commandTable[] =
    {
        ...
        { "save",           SEC_MODERATOR,      false, &ChatHandler::HandleSaveCommand,                "", NULL },
...
const char *ChatHandler::GetQuadString(int32 entry) const
{
    return m_session->GetQuadString(entry);
}
...
{
    SendSysMessage(GetQuadString(entry));
}
...
GameObject* ChatHandler::GetNearbyGameObject()
{
    ...
    GameObject* obj = NULL;
    Quad::NearestGameObjectCheck check(*pl);
    Quad::GameObjectLastSearcher<Quad::NearestGameObjectCheck> searcher(pl, obj, check);
...
GameObject* ChatHandler::GetObjectGlobalyWithGuidOrNearWithDbGuid(uint32 lowguid,uint32 entry)
{
    ...
    if (!obj && objmgr.GetGOData(lowguid))                   // guid is DB guid of object
    {
        ...
        TypeContainerVisitor<Quad::GameObjectSearcher<Quad::GameObjectWithDbGUIDCheck>, GridTypeMapContainer > object_checker(checker);
...
{
    return GetQuadString(LANG_CONSOLE_COMMAND);
}
