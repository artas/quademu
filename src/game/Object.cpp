...
void WorldObject::MovePosition(Position &pos, float dist, float angle)
{
    ...
    Quad::NormalizeMapCoord(pos.m_positionX);
    Quad::NormalizeMapCoord(pos.m_positionY);
...
void WorldObject::DestroyForNearbyPlayers()
{
    ...
    Quad::AnyUnitInObjectRangeCheck check(this, GetMap()->GetVisibilityDistance());
    Quad::UnitListSearcher<Quad::AnyUnitInObjectRangeCheck> searcher(this, targets, check);
