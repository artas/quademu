...
#ifndef QUAD_FLEEINGMOVEMENTGENERATOR_H
#define QUAD_FLEEINGMOVEMENTGENERATOR_H
...
template<class T>
class QUAD_DLL_SPEC FleeingMovementGenerator
...
class CORE_DLL_SPEC TimedFleeingMovementGenerator
