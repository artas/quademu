...
#ifndef QUAD_MOVEMENTGENERATOR_H
#define QUAD_MOVEMENTGENERATOR_H
...
class QUAD_DLL_SPEC MovementGenerator
{
    public:
...
class QUAD_DLL_SPEC MovementGeneratorMedium : public MovementGenerator
{
    public:
