...
bool OPvPCapturePoint::Update(uint32 diff)
{
    ...
    Quad::AnyPlayerInObjectRangeCheck checker(m_capturePoint, radius);
    Quad::PlayerListSearcher<Quad::AnyPlayerInObjectRangeCheck> searcher(m_capturePoint, players, checker);
