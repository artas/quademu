...
#ifndef QUADCORE_CHAT_H
#define QUADCORE_CHAT_H
...
class QUAD_DLL_SPEC ChatHandler
{
    public:
...
//        bool HandleReloadAuctionsCommand(const char* args);
        ...
        bool HandleReloadQuadStringCommand(const char* args);
...
class CliHandler : public ChatHandler
{
    public:
        ...
        // overwrite functions
        const char *GetQuadString(int32 entry) const;
