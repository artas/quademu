...
#ifndef QUAD_UNITAI_H
#define QUAD_UNITAI_H
...
class QUAD_DLL_SPEC PlayerAI : public UnitAI
{
    protected:
        Player* const me;
    public:
...
class QUAD_DLL_SPEC SimpleCharmedAI : public PlayerAI
{
    public:
