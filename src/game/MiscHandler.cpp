...
void WorldSession::HandleWhoOpcode( WorldPacket & recv_data )
{
    ...
    // client send in case not set max level value 100 but core support 255 max level,
...
void WorldSession::HandleLogoutRequestOpcode( WorldPacket & /*recv_data*/ )
{
    ...
    //instant logout in taverns/cities or on taxi or for admins, gm's, mod's if its enabled in cored.conf
...
void WorldSession::HandleAddFriendOpcode( WorldPacket & recv_data )
{
    ...
    std::string friendName = GetQuadString(LANG_FRIEND_IGNORE_UNKNOWN);
...
void WorldSession::HandleAddIgnoreOpcode( WorldPacket & recv_data )
{
    ...
    std::string IgnoreName = GetQuadString(LANG_FRIEND_IGNORE_UNKNOWN);
