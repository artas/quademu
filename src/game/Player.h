...
// 2^n values, Player::m_isunderwater is a bitmask. These are core internal values, they are never send to any client
...
class QUAD_DLL_SPEC PlayerTaxi
{
    public:
        PlayerTaxi();
        ~PlayerTaxi() {}
...
class CORE_DLL_SPEC Player : public Unit
{
