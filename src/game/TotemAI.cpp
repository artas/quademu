...
TotemAI::UpdateAI(const uint32 /*diff*/)
{
    ...
    {
        victim = NULL;
        Quad::NearestAttackableUnitInObjectRangeCheck u_check(m_creature, m_creature, max_range);
        Quad::UnitLastSearcher<Quad::NearestAttackableUnitInObjectRangeCheck> checker(m_creature, victim, u_check);
