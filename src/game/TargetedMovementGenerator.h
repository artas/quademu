...
#ifndef QUAD_TARGETEDMOVEMENTGENERATOR_H
#define QUAD_TARGETEDMOVEMENTGENERATOR_H
...
class QUAD_DLL_SPEC TargetedMovementGeneratorBase
{
    public:
...
template<class T>
class QUAD_DLL_SPEC TargetedMovementGenerator
