...
struct QUAD_DLL_DECL guardAI : public ScriptedAI
{
    public:
...
struct QUAD_DLL_DECL guardAI_orgrimmar : public guardAI
{
...
struct QUAD_DLL_DECL guardAI_stormwind : public guardAI
{
