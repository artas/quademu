...
struct QUAD_DLL_DECL example_escortAI : public npc_escortAI
{
...
bool GossipSelect_example_escort(Player* pPlayer, Creature* pCreature, uint32 uiSender, uint32 uiAction)
{
    ...
    switch(uiAction)
    {
        ...
        case GOSSIP_ACTION_INFO_DEF+3:
            ...
            break;
        default:
            return false;                                   // nothing defined      -> quad core handling
    }

    return true;                                            // no default handling  -> prevent quad core handling
}
