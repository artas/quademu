...
#define MSG_GOSSIP_SELL "Продать Гильд Хаус"
#define MSG_GOSSIP_NEXTPAGE "Следующая -->"
#define MSG_INCOMBAT "Вы в бою!"
#define MSG_NOGUILDHOUSE "У вашей гильдии нет Гильд Хауса!"
#define MSG_NOFREEGH "Извините, все Гильд Хаусы заняты."
#define MSG_ALREADYHAVEGH "У вашей гильдии уже есть Гильд Хаус, %s."
#define MSG_NOTENOUGHMONEY "Не хватает денег. Нужно %u золота чтобы купить Гильд Хаус."
#define MSG_GHOCCUPIED "Извините, этот Гильд Хаус занят."
#define MSG_CONGRATULATIONS "Поздравляем! Вы купили Гильд Хаус."
#define MSG_SOLD "Вы продали Гильд Хаус. Вот ваши деньги %u."
#define MSG_NOTINGUILD "Вы не состоите в гильдии."
 
#define CODE_SELL "SELL"
#define MSG_CODEBOX_SELL "Введите \"" CODE_SELL "\" если вы хотите продать свой Гильд Хаус."
