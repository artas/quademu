...
player->ADD_GOSSIP_ITEM( 5, "Gurubashi arena 5 Silver"        , GOSSIP_SENDER_MAIN, 2000);
player->ADD_GOSSIP_ITEM( 5, "Booty bay 5 Silver"        , GOSSIP_SENDER_MAIN, 2001);
...
case 2000:
player->CLOSE_GOSSIP_MENU();
player->TeleportTo(0, -13262.799805f,160.932007f,36.381802f,1.068150f); 
player->ModifyMoney(-1*costo);
...
case 2001:
player->CLOSE_GOSSIP_MENU();
player->TeleportTo(0, -14427.707031f,449.105774f,15.420253f,5.309291f); 
player->ModifyMoney(-1*costo);
