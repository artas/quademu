...
struct QUAD_DLL_DECL npc_unworthy_initiateAI : public ScriptedAI
{
...
struct QUAD_DLL_DECL npc_unworthy_initiate_anchorAI : public PassiveAI
{
...
struct QUAD_DLL_DECL npc_death_knight_initiateAI : public CombatAI
{
...
struct QUAD_DLL_DECL npc_dark_rider_of_acherusAI : public ScriptedAI
{
...
struct QUAD_DLL_DECL npc_salanar_the_horsemanAI : public ScriptedAI
{
...
struct QUAD_DLL_DECL npc_ros_dark_riderAI : public ScriptedAI
{
...
struct QUAD_DLL_DECL npc_dkc1_gothikAI : public ScriptedAI
{
...
struct QUAD_DLL_DECL npc_scarlet_ghoulAI : public ScriptedAI
{
...
struct QUAD_DLL_DECL npc_scarlet_miner_cartAI : public PassiveAI
{
...
struct QUAD_DLL_DECL npc_scarlet_minerAI : public npc_escortAI
{
...
bool GOHello_go_inconspicuous_mine_car(Player* pPlayer, GameObject* pGO)
{
    ...
    {
        // Hack Why Quad Dont Support Custom Summon Location
        if(Creature *miner = pPlayer->SummonCreature(28841, 2383.869629, -5900.312500, 107.996086, pPlayer->GetOrientation(),TEMPSUMMON_DEAD_DESPAWN, 1))
        {
            ...
            if(Creature *car = pPlayer->GetVehicleCreatureBase())
            {
                ...
                } else error_log("QUADSCRIPT: GOHello_go_inconspicuous_mine_car vehicle entry is not correct.");
            } else error_log("QUADSCRIPT: GOHello_go_inconspicuous_mine_car player is not on the vehicle.");
        } else error_log("QUADSCRIPT: GOHello_go_inconspicuous_mine_car Scarlet Miner cant be found by script.");
    }
    return true;
}
