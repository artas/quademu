...
struct QUAD_DLL_DECL npc_grimstoneAI : public npc_escortAI
{
    ...
    void WaypointReached(uint32 i)
    {
        ...
        case 5:
            if (pInstance)
            {
                ...
                debug_log("QUADSCRIPT: npc_grimstone: event reached end and set complete.");
            }
            break;
        }
    }
...
struct QUAD_DLL_DECL mob_phalanxAI : public ScriptedAI
{
...
/*
struct QUAD_DLL_DECL npc_dughal_stormwingAI : public npc_escortAI
{
...
Player* pPlayerStart;
/*
struct QUAD_DLL_DECL npc_marshal_windsorAI : public npc_escortAI
{
...
int wp = 0;
/*
struct QUAD_DLL_DECL npc_marshal_reginald_windsorAI : public npc_escortAI
{
...
/*
struct QUAD_DLL_DECL npc_tobias_seecherAI : public npc_escortAI
{
...
struct QUAD_DLL_DECL npc_rocknotAI : public npc_escortAI
{
