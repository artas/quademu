...
struct QUAD_DLL_DECL boss_felmystAI : public ScriptedAI
{
    ...
    void DespawnSummons(uint32 entry)
    {
...

        {
            ...
            Quad::AllCreaturesOfEntryInRange check(m_creature, entry, 100);
...
struct QUAD_DLL_DECL mob_felmyst_vaporAI : public ScriptedAI
{
...
struct QUAD_DLL_DECL mob_felmyst_trailAI : public ScriptedAI
{
