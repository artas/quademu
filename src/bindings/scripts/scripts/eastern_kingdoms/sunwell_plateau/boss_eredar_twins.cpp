...
struct QUAD_DLL_DECL boss_sacrolashAI : public ScriptedAI
{
...
struct QUAD_DLL_DECL boss_alythessAI : public Scripted_NoMovementAI
{
...
struct QUAD_DLL_DECL mob_shadow_imageAI : public ScriptedAI
{
