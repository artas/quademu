...
struct QUAD_DLL_DECL boss_kalecgosAI : public ScriptedAI
{
        ...
        else
        {
            ...
            if (CheckTimer <= diff)
            {
                ...
                if (!isBanished && HealthBelowPct(1))
                {
                    ...
                    {
                        error_log("QUADSCRIPT: Didn't find Shathrowar. Kalecgos event reseted.");
                        EnterEvadeMode();
                        return;
                    }
                }
...
struct QUAD_DLL_DECL boss_sathrovarrAI : public ScriptedAI
{
...
struct QUAD_DLL_DECL boss_kalecAI : public ScriptedAI
{
    ScriptedInstance *pInstance;
