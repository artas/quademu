...
struct QUAD_DLL_DECL boss_nalorakkAI : public ScriptedAI
{
    ...
    void SendAttacker(Unit *pTarget)
    {
...

        {
            ...
            Quad::AllFriendlyCreaturesInGrid check(m_creature);
            Quad::CreatureListSearcher<Quad::AllFriendlyCreaturesInGrid> searcher(m_creature, templist, check);

            TypeContainerVisitor<Quad::CreatureListSearcher<Quad::AllFriendlyCreaturesInGrid>, GridTypeMapContainer> cSearcher(searcher);
