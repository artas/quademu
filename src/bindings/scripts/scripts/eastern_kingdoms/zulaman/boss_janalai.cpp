...
struct QUAD_DLL_DECL boss_janalaiAI : public ScriptedAI
{
...
//        DoZoneInCombat();
    ...
    bool HatchAllEggs(uint32 uiAction) //1: reset, 2: isHatching all
    {
...

        {
            ...
            Quad::AllCreaturesOfEntryInRange check(m_creature, MOB_EGG, 100);
            Quad::CreatureListSearcher<Quad::AllCreaturesOfEntryInRange> searcher(m_creature, templist, check);

            TypeContainerVisitor<Quad::CreatureListSearcher<Quad::AllCreaturesOfEntryInRange>, GridTypeMapContainer> cSearcher(searcher);
    ...
    void Boom()
    {
...

        {
            ...
            Quad::AllCreaturesOfEntryInRange check(m_creature, MOB_FIRE_BOMB, 100);
            Quad::CreatureListSearcher<Quad::AllCreaturesOfEntryInRange> searcher(m_creature, templist, check);
...
struct QUAD_DLL_DECL mob_janalai_firebombAI : public ScriptedAI
{
...
struct QUAD_DLL_DECL mob_amanishi_hatcherAI : public ScriptedAI
{
    ...
    bool HatchEggs(uint32 num)
    {
...

        {
            ...
            Quad::AllCreaturesOfEntryInRange check(m_creature, 23817, 50);
            Quad::CreatureListSearcher<Quad::AllCreaturesOfEntryInRange> searcher(m_creature, templist, check);
...
struct QUAD_DLL_DECL mob_hatchlingAI : public ScriptedAI
{
...
struct QUAD_DLL_DECL mob_eggAI : public ScriptedAI
{
