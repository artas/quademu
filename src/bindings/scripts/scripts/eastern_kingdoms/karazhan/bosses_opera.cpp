...
struct QUAD_DLL_DECL boss_dorotheeAI : public ScriptedAI
{
...
struct QUAD_DLL_DECL mob_titoAI : public ScriptedAI
{
...
struct QUAD_DLL_DECL boss_strawmanAI : public ScriptedAI
{
...
struct QUAD_DLL_DECL boss_tinheadAI : public ScriptedAI
{
...
struct QUAD_DLL_DECL boss_roarAI : public ScriptedAI
{
...
struct QUAD_DLL_DECL boss_croneAI : public ScriptedAI
{
...
struct QUAD_DLL_DECL mob_cycloneAI : public ScriptedAI
{
...
struct QUAD_DLL_DECL boss_bigbadwolfAI : public ScriptedAI
{
...
struct QUAD_DLL_DECL boss_julianneAI : public ScriptedAI
{
...
struct QUAD_DLL_DECL boss_romuloAI : public ScriptedAI
{
...
void boss_julianneAI::DamageTaken(Unit* done_by, uint32 &damage)
{
    ...
    {
        error_log("QUADSCRIPT: boss_julianneAI: cannot take damage in PHASE_ROMULO, why was i here?");
        damage = 0;
        return;
    }
    ...
    error_log("QUADSCRIPT: boss_julianneAI: DamageTaken reach end of code, that should not happen.");
}
...
void boss_romuloAI::DamageTaken(Unit* done_by, uint32 &damage)
{
    ...
    error_log("QUADSCRIPT: boss_romuloAI: DamageTaken reach end of code, that should not happen.");
}
