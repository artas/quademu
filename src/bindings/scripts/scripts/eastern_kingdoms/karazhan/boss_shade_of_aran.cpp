...
struct QUAD_DLL_DECL boss_aranAI : public ScriptedAI
{
...
struct QUAD_DLL_DECL water_elementalAI : public ScriptedAI
{
...
{
    outstring_log("QUADSCRIPT: Convert simpleAI script for Creature Entry %u to ACID", pCreature->GetEntry());
