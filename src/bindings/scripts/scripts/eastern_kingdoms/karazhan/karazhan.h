...
#define ERROR_INST_DATA(a)          error_log("QUADSCRIPT: Instance Data for Karazhan not set properly. Encounter for Creature Entry %u may not work properly.", a->GetEntry());
#endif
