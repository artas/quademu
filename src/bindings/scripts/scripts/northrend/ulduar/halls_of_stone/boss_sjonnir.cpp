...
struct QUAD_DLL_DECL boss_sjonnirAI : public ScriptedAI
{
...
struct QUAD_DLL_DECL mob_malformed_oozeAI : public ScriptedAI
{
...
struct QUAD_DLL_DECL mob_iron_sludgeAI : public ScriptedAI
{
