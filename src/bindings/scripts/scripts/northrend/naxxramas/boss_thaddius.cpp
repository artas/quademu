...
struct QUAD_DLL_DECL boss_thaddiusAI : public BossAI
{
...
struct QUAD_DLL_DECL mob_stalaggAI : public ScriptedAI
{
...
struct QUAD_DLL_DECL mob_feugenAI : public ScriptedAI
{
