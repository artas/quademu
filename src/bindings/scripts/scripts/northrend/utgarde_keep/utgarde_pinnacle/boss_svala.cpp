...
struct QUAD_DLL_DECL boss_svalaAI : public ScriptedAI
{
...
struct QUAD_DLL_DECL mob_ritual_channelerAI : public Scripted_NoMovementAI
{
...
struct QUAD_DLL_DECL boss_svala_sorrowgraveAI : public ScriptedAI
{
