...
struct QUAD_DLL_DECL boss_ingvar_the_plundererAI : public ScriptedAI
{
...
struct QUAD_DLL_DECL mob_annhylde_the_callerAI : public ScriptedAI
{
...
struct QUAD_DLL_DECL mob_ingvar_throw_dummyAI : public ScriptedAI
{
