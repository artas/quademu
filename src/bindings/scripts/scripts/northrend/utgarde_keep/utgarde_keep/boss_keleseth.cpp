...
struct QUAD_DLL_DECL mob_frost_tombAI : public ScriptedAI
{
...
struct QUAD_DLL_DECL boss_kelesethAI : public ScriptedAI
{
...
struct QUAD_DLL_DECL mob_vrykul_skeletonAI : public ScriptedAI
{
