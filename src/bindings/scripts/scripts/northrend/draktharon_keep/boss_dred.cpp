...
struct QUAD_DLL_DECL boss_dredAI : public ScriptedAI
{
...
struct QUAD_DLL_DECL npc_drakkari_gutripperAI : public ScriptedAI
{
...
struct QUAD_DLL_DECL npc_drakkari_scytheclawAI : public ScriptedAI
{
