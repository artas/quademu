...
struct QUAD_DLL_DECL boss_ormorokAI : public ScriptedAI
{
...
struct QUAD_DLL_DECL mob_crystal_spikeAI : public Scripted_NoMovementAI
{
...
struct QUAD_DLL_DECL mob_crystalline_tanglerAI : public ScriptedAI
{
