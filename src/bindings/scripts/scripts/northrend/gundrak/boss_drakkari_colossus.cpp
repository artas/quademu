...
struct QUAD_DLL_DECL boss_drakkari_colossusAI : public ScriptedAI
{
...
struct QUAD_DLL_DECL boss_drakkari_elementalAI : public ScriptedAI
{
...
struct QUAD_DLL_DECL npc_living_mojoAI : public ScriptedAI
{
