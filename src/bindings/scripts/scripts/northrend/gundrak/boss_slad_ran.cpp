...
struct QUAD_DLL_DECL boss_slad_ranAI : public ScriptedAI
{
...
struct QUAD_DLL_DECL mob_slad_ran_constrictorAI : public ScriptedAI
{
...
struct QUAD_DLL_DECL mob_slad_ran_viperAI : public ScriptedAI
{
