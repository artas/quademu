...
struct QUAD_DLL_DECL advisorbase_ai : public ScriptedAI
{
...
//Kael'thas AI
struct QUAD_DLL_DECL boss_kaelthasAI : public ScriptedAI
{
    ...
    void StartEvent()
    {
        ...
        {
            error_log("QUADSCRIPT: Kael'Thas One or more advisors missing, Skipping Phases 1-3");
...
struct QUAD_DLL_DECL boss_thaladred_the_darkenerAI : public advisorbase_ai
{
...
//Lord Sanguinar AI
struct QUAD_DLL_DECL boss_lord_sanguinarAI : public advisorbase_ai
{
...
struct QUAD_DLL_DECL boss_grand_astromancer_capernianAI : public advisorbase_ai
{
...
struct QUAD_DLL_DECL boss_master_engineer_telonicusAI : public advisorbase_ai
{
...
//Flame Strike AI
struct QUAD_DLL_DECL mob_kael_flamestrikeAI : public Scripted_NoMovementAI
{
...
//Phoenix AI
struct QUAD_DLL_DECL mob_phoenix_tkAI : public ScriptedAI
{
...
//Phoenix Egg AI
struct QUAD_DLL_DECL mob_phoenix_egg_tkAI : public ScriptedAI
{
