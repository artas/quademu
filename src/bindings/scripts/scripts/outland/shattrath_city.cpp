...
struct QUAD_DLL_DECL npc_raliq_the_drunkAI : public ScriptedAI
{
...
struct QUAD_DLL_DECL npc_salsalabimAI : public ScriptedAI
{
...
struct QUAD_DLL_DECL npc_kservantAI : public npc_escortAI
{
public:
...
struct QUAD_DLL_DECL npc_dirty_larryAI : public ScriptedAI
{
