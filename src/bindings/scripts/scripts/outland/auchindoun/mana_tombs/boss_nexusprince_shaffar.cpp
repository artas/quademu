...
struct QUAD_DLL_DECL boss_nexusprince_shaffarAI : public ScriptedAI
{
...
struct QUAD_DLL_DECL mob_ethereal_beaconAI : public ScriptedAI
{
...
struct QUAD_DLL_DECL mob_ethereal_apprenticeAI : public ScriptedAI
{
