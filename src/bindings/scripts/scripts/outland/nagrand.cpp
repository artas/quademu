...
struct QUAD_DLL_DECL mob_shattered_rumblerAI : public ScriptedAI
{
    bool Spawn;
...
struct QUAD_DLL_DECL mob_lumpAI : public ScriptedAI
{
...
struct QUAD_DLL_DECL mob_sunspring_villagerAI : public ScriptedAI
{
...
struct QUAD_DLL_DECL npc_maghar_captiveAI : public npc_escortAI
{
...
struct QUAD_DLL_DECL npc_creditmarker_visit_with_ancestorsAI : public ScriptedAI
{
...
struct QUAD_DLL_DECL mob_sparrowhawkAI : public ScriptedAI
{
