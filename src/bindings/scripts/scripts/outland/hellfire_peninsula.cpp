...
struct QUAD_DLL_DECL npc_aeranasAI : public ScriptedAI
{
...
struct QUAD_DLL_DECL npc_ancestral_wolfAI : public npc_escortAI
{
    npc_ancestral_wolfAI(Creature* pCreature) : npc_escortAI(pCreature)
    {
        if (pCreature->GetOwner() && pCreature->GetOwner()->GetTypeId() == TYPEID_PLAYER)
            ...
            error_log("QUAD: npc_ancestral_wolf can not obtain owner or owner is not a player.");
...
struct QUAD_DLL_DECL npc_wounded_blood_elfAI : public npc_escortAI
{
