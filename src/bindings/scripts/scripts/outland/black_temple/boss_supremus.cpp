...
struct QUAD_DLL_DECL molten_flameAI : public NullCreatureAI
{
...
struct QUAD_DLL_DECL boss_supremusAI : public ScriptedAI
{
...
struct QUAD_DLL_DECL npc_volcanoAI : public Scripted_NoMovementAI
{
