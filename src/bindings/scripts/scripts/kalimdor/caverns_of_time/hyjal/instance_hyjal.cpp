...
struct QUAD_DLL_DECL instance_mount_hyjal : public ScriptedInstance
{
    ...
    void SetData(uint32 type, uint32 data)
    {
        switch(type)
        {
         ...
         debug_log("QUADSCRIPT: Instance Hyjal: Instance data updated for event %u (Data=%u)",type,data);
