...
struct QUAD_DLL_DECL mobs_risen_husk_spiritAI : public ScriptedAI
{
...
struct QUAD_DLL_DECL npc_deserter_agitatorAI : public ScriptedAI
{
...
struct QUAD_DLL_DECL npc_private_hendelAI : public ScriptedAI
{
