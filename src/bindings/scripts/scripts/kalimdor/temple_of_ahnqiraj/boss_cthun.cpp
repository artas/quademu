...
struct QUAD_DLL_DECL flesh_tentacleAI : public ScriptedAI
{
...
struct QUAD_DLL_DECL eye_of_cthunAI : public Scripted_NoMovementAI
{
    eye_of_cthunAI(Creature *c) : Scripted_NoMovementAI(c)
    {
        pInst = c->GetInstanceData();
        if (!pInst)
            error_log("QUADSCRIPT: No Instance eye_of_cthunAI");
    }
...
struct QUAD_DLL_DECL cthunAI : public ScriptedAI
{
...
struct QUAD_DLL_DECL eye_tentacleAI : public ScriptedAI
{
...
struct QUAD_DLL_DECL claw_tentacleAI : public ScriptedAI
{
...
struct QUAD_DLL_DECL giant_claw_tentacleAI : public ScriptedAI
{
...
struct QUAD_DLL_DECL giant_eye_tentacleAI : public ScriptedAI
{
...
void flesh_tentacleAI::JustDied(Unit* killer)
{
    if (!Parent)
    {
        error_log("QUADSCRIPT: flesh_tentacle: No Parent variable");
        return;
    }
    ...
    else error_log("QUADSCRIPT: flesh_tentacle: No Cthun");
}
