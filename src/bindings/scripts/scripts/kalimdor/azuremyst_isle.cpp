...
struct QUAD_DLL_DECL npc_draenei_survivorAI : public ScriptedAI
{
...
struct QUAD_DLL_DECL npc_engineer_spark_overgrindAI : public ScriptedAI
{
...
struct QUAD_DLL_DECL npc_injured_draeneiAI : public ScriptedAI
{
...
struct QUAD_DLL_DECL npc_magwinAI : public npc_escortAI
{
...
struct QUAD_DLL_DECL npc_geezleAI : public ScriptedAI
{
    ...
    void CompleteQuest()
    {
        ...
        Quad::AnyPlayerInObjectRangeCheck checker(m_creature, radius);
        Quad::PlayerListSearcher<Quad::AnyPlayerInObjectRangeCheck> searcher(m_creature, players, checker);
...
struct QUAD_DLL_DECL npc_nestlewood_owlkinAI : public ScriptedAI
{
...
struct QUAD_DLL_DECL npc_death_ravagerAI : public ScriptedAI
{
