...
struct QUAD_DLL_DECL npc_air_force_botsAI : public ScriptedAI
{
...
struct QUAD_DLL_DECL npc_chicken_cluckAI : public ScriptedAI
{
...
struct QUAD_DLL_DECL npc_dancing_flamesAI : public ScriptedAI
{
...
struct QUAD_DLL_DECL npc_doctorAI : public ScriptedAI
{
...
struct QUAD_DLL_DECL npc_injured_patientAI : public ScriptedAI
{
    ...
    if (Event)
    {
        if (SummonPatient_Timer <= diff)
        {
            ...
            switch(m_creature->GetEntry())
            {
                ...
                default:
                    error_log("QUADSCRIPT: Invalid entry for Triage doctor. Please check your database");
                    return;
            }
...
struct QUAD_DLL_DECL npc_garments_of_questsAI : public npc_escortAI
{
...
struct QUAD_DLL_DECL npc_guardianAI : public ScriptedAI
{
...
struct QUAD_DLL_DECL npc_steam_tonkAI : public ScriptedAI
{
...
struct QUAD_DLL_DECL npc_tonk_mineAI : public ScriptedAI
{
...
struct QUAD_DLL_DECL npc_snake_trap_serpentsAI : public ScriptedAI
{
...
struct QUAD_DLL_DECL mob_mojoAI : public ScriptedAI
{
...
struct QUAD_DLL_DECL npc_mirror_image : CasterAI
{
...
struct QUAD_DLL_DECL npc_ebon_gargoyleAI : CasterAI
{
    ...
    void InitializeAI()
    {
        ...
        Quad::AnyUnfriendlyUnitInObjectRangeCheck u_check(m_creature, m_creature, 30);
        Quad::UnitListSearcher<Quad::AnyUnfriendlyUnitInObjectRangeCheck> searcher(m_creature, targets, u_check);
...
struct QUAD_DLL_DECL npc_lightwellAI : public PassiveAI
{
