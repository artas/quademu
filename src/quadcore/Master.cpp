...
int Master::Run()
{
    ...
    sLog.outString( "   ___________________________________________________________________ " );	
    sLog.outString( "   @@@@                              @@   |@@@@@@@            @@    @@ " );
    sLog.outString( "  @@  @@                             @@   |@@                 @@    @@ " );
    sLog.outString( " @@    @@  @@    @@   @@@@@@    @@@@ @@   |@@       @@@@ @@@  @@    @@ " );
    sLog.outString( " @@    @@  @@    @@  @@    @   @@   @@@   |@@@@@@   @@  @  @@ @@    @@ " );
    ...
    sLog.outString( "  @@ @ @@  @@   @@@  @@    @   @@   @@@   |@@       @@  @  @@ @@    @@ " );
    sLog.outString( "   @@@@@    @@@@ @@   @@@@@@@   @@@@ @@   |@@@@@@@  @@  @  @@  @@@@@@  " );
    sLog.outString( "       @@_____________________________________________________________ " );    
    sLog.outString( "   Quad emu project                                                   \n");  
