...
#ifndef QUADCORE_LOG_H
#define QUADCORE_LOG_H
...
class Log : public Quad::Singleton<Log, Quad::ClassLevelLockable<Log, ACE_Thread_Mutex> >
{
    friend class Quad::OperatorNew<Log>;
    Log();
    ~Log();
...
#define sLog Quad::Singleton<Log>::Instance()

#ifdef QUAD_DEBUG
#define DEBUG_LOG Quad::Singleton<Log>::Instance().outDebug
#else
#define DEBUG_LOG
#endif

// primary for script library
void QUAD_DLL_SPEC outstring_log(const char * str, ...) ATTR_PRINTF(1,2);
void QUAD_DLL_SPEC detail_log(const char * str, ...) ATTR_PRINTF(1,2);
void QUAD_DLL_SPEC debug_log(const char * str, ...) ATTR_PRINTF(1,2);
void QUAD_DLL_SPEC error_log(const char * str, ...) ATTR_PRINTF(1,2);
void QUAD_DLL_SPEC error_db_log(const char * str, ...) ATTR_PRINTF(1,2);
#endif
